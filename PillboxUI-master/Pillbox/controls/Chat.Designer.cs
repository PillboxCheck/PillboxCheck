namespace Pillbox.controls
{
    partial class Chat
    {
        ...
        private void InitializeComponent()
        {
            ...
            // sendButton
            // 
            sendButton.CheckedState.Image = (Image)resources.GetObject("resource.Image");
            sendButton.CheckedState.ImageSize = new Size(32, 32);
            sendButton.HoverState.ImageSize = new Size(32, 32);
            sendButton.Image = (Image)resources.GetObject("sendButton.Image");
            sendButton.ImageOffset = new Point(0, 0);
            sendButton.ImageRotate = 0F;
            sendButton.ImageSize = new Size(32, 32);
            sendButton.Location = new Point(1489, 45);
            sendButton.Name = "sendButton";
            sendButton.PressedState.ImageSize = new Size(64, 64);
            sendButton.ShadowDecoration.CustomizableEdges = customizableEdges1;
            sendButton.Size = new Size(59, 58);
