...
print("-------------------------------------------------")
internal_assistant_label = INTERNAL_ASSISTANT_PROMPT | llm | StrOutputParser()
...
while True:
    try:
        ...
        data = input("Enter JSON data (or 'exit' to quit): ")
        if not data:
        ...
        json_data = {"question": data, "RAGBool":True, "Internal":False}
